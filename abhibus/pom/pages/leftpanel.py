...
class LeftPanel(Events):
    ...
    def selectPriceDropCheckbox(self, locator_type="xpath"):
        ...
        pricedrop_checkbox_defstatus = self.isElementSelected(self.price_drop_checkbox, locator_type)
        print("price drop checkbox default status is: " + str(pricedrop_checkbox_defstatus))
        if not pricedrop_checkbox_defstatus:
            ...
            # time.sleep(5)
        return pricedrop_checkbox_defstatus, pricedrop_checkbox_status
