class AllLocators:
    ...
    buses_link = "bus-link"
    trains_link = "train-link"
    hotels_link = "hotel-link"
    rentals_link = "pills-rental-tab"
    from_station_textbox = "//input[@placeholder='From Station']"
    source_cities_list = "//div[@id='search-from']//ul//li//div[@class=' col']"
    to_station_textbox = "//input[@placeholder='To Station']"
    destination_cities_list = "//div[@id='search-to']//ul//li//div[@class=' col']"
    date_of_journey_field = "//label[text()='Date of Journey']//..//input[@id='datepicker1']"
    journey_date = "//input[@placeholder='Onward Journey Date']"
    month_name = "//div[@class='container month ']//div[@class=' col']/span[1]"
    year_name = "//div[@class='container month ']//div[@class=' col']/span[2]"
    prev_btn = "//div[@class='container calendar  ']//div[@class=' col auto'][1]"
    next_btn = "//div[@class='container calendar  ']//div[@class=' col auto'][2]"
    dates_list = "//div[@class='container date ']//span[@data-date]"
