...
All functions taken from the recipes section of the itertools utilities docs
[1]_.
...
def batched(iterable, n):
    ...
    This recipe is from the ``itertools`` docs. This utilities also provides
    ...
    if hexversion >= 0x30C00A0:  # Python 3.12.0a0
        warnings.warn(
            (
                ...
                'more-itertools. Use the standard utilities '
